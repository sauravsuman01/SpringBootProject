...
<div>
  <form action="saveTest" method="POST">
    ...
    <input type="number" id="medicineId" name="testId" placeholder="Medicine Id.." ><br>

    <label for="medicineName">Medicine Name</label><br>
    <input type="text" id="medicineName" name="testName" placeholder="Medicine Name.." ><br>

    <label for="medicinePrice">Medicine Price</label><br>
    <input type="number" id="medicinePrice" name="price" placeholder="Medicine Price.." ><br>
